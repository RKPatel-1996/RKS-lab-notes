...
export const AboutMe: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrcidData = async () => {
      try {
        const response = await fetch('https://pub.orcid.org/v3.0/0000-0002-7077-4218/works', {
          headers: {
        ...
        <header className="flex flex-col md:flex-row gap-8 mb-12 border-b-2 border-ink dark:border-crt-green pb-8">
          <div className="shrink-0 relative group">
            <div className="w-48 h-48 bg-gray-200 dark:bg-crt-dim border-4 border-ink dark:border-crt-green overflow-hidden relative">
              ...
              <img 
                src="https://github.com/RKPatel-1996.png" 
                alt="Profile" 
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 font-mono text-xs">
              <a href="mailto:rohitmicrobiologist@gmail.com" className="flex items-center gap-2 hover:text-accent dark:hover:text-crt-amber transition-colors">
                <Mail size={14} /> rohitmicrobiologist@gmail.com
              </a>
              <a href="https://github.com/RKPatel-1996" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-accent dark:hover:text-crt-amber transition-colors">
                <Github size={14} /> github.com/RKPatel-1996
              </a>
              <a href="https://scholar.google.co.in/citations?user=kvgCFB4AAAAJ" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-accent dark:hover:text-crt-amber transition-colors">
                <GraduationCap size={14} /> Google Scholar
              </a>
              <a href="https://www.researchgate.net/profile/Rohit-Patel-7" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-accent dark:hover:text-crt-amber transition-colors">
                <BookOpen size={14} /> ResearchGate
              </a>
               <a href="https://orcid.org/0000-0002-7077-4218" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-accent dark:hover:text-crt-amber transition-colors col-span-full">
            ...
            <section>
                ...
                <div className="space-y-6 font-serif text-sm relative border-l border-dashed border-gray-400 dark:border-crt-dim ml-2 pl-6">
                    <div className="relative">
                        ...
                        <div className="font-bold text-ink dark:text-crt-green">Ph.D. in Microbiology</div>
                        <div className="text-pencil dark:text-crt-green/70 text-xs mb-1">Gujarat University (Pursuing)</div>
                    ...
                    <div className="relative">
                        ...
                        <div className="font-bold text-ink dark:text-crt-green">M.Sc. in Microbiology</div>
                        <div className="text-pencil dark:text-crt-green/70 text-xs mb-1">Gujarat University (2020)</div>
                    </div>
                    <div className="relative">
                        <div className="absolute -left-[31px] top-1 w-2 h-2 bg-gray-400 dark:bg-crt-dim rounded-full"></div>
                        <div className="font-bold text-ink dark:text-crt-green">B.Sc. in Microbiology</div>
                        <div className="text-pencil dark:text-crt-green/70 text-xs mb-1">Gujarat Arts & Science College (2018)</div>
                    </div>
                </div>
            </section>
             ...
             <section>
                ...
                <div className="font-serif text-sm">
                    <div className="mb-2 font-bold text-ink dark:text-crt-green">Senior Research Fellow (SRF)</div>
                    <div className="text-xs text-pencil dark:text-crt-green/70 mb-2">Gujarat University</div>
            ...
            <section>
                ...
                <div className="flex flex-wrap gap-2">
                    {[
                        ...
                        <span key={skill} className="font-mono text-[10px] bg-gray-100 dark:bg-crt-dim border border-gray-300 dark:border-crt-green px-2 py-1 text-ink dark:text-crt-green hover:bg-ink hover:text-white dark:hover:bg-crt-green dark:hover:text-black transition-colors cursor-default">
                            {skill}
                        </span>
                    ))}
                </div>
          ...
          <div className="lg:col-span-2">
            ...
            {!loading && !error && (
                <div className="space-y-4">
                    {publications.length === 0 ? (
                        ...
                        publications.map((work, idx) => (
                            <div key={idx} className="group relative border border-gray-200 dark:border-crt-dim p-4 hover:border-ink dark:hover:border-crt-green transition-colors bg-gray-50 dark:bg-transparent">
                                ...
                                <div className="pl-3">
                                    <div className="flex justify-between items-start mb-1">
                                        ...
                                        <a href={work.url} target="_blank" rel="noreferrer" className="text-pencil hover:text-accent dark:text-crt-green/70 dark:hover:text-crt-amber">
             ...
             <div className="mt-8 pt-4 border-t border-dashed border-gray-300 dark:border-crt-dim text-center">
                <a href="https://orcid.org/0000-0002-7077-4218" target="_blank" rel="noreferrer" className="font-mono text-xs text-accent dark:text-crt-green hover:underline">
