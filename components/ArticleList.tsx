...
export const ArticleList: React.FC<ArticleListProps> = ({ articles, onSelect }) => {
    ...
    <div className="flex flex-col min-h-full p-6 max-w-5xl mx-auto w-full">
      ...
      <div className="mb-8">
        ...
        <div className="relative mb-6">
            ...
            {searchQuery === '' && (
                <span className="absolute left-[200px] top-1/2 -translate-y-1/2 font-mono animate-blink text-ink dark:text-crt-green">_</span>
            )}
        </div>
                ...
                {filteredArticles.map((article) => (
                    ...
                    >
                        <td className="py-4 pl-4 align-top">
                            <FileText className="text-pencil dark:text-crt-green" size={20} />
                        </td>
                        ...
                        <td className="py-4 align-top">
                            <div className="flex flex-wrap gap-1">
                                {article.tags.map(tag => (
                                    <span key={tag} className="font-mono text-[10px] border border-gray-300 dark:border-crt-green px-1 rounded text-pencil dark:text-crt-green">
                                        {tag}
                                    </span>
                                ))}
                            </div>
