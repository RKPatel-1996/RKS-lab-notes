const e="/RKS-lab-notes/assets/2dn1_3hrw_alignement_008-Ve3mY_oq.png",t="/RKS-lab-notes/assets/2DN1_alpha_beta_008_2-TZHwMwjX.png",o={id:"RK-2026-008",title:"Biological Sequence Comparison: Matrices and Foundational Concepts",date:"2026-01-09",tags:["#sequenceSimilarity","#alignment","#Matrices"],type:"report",template:"standard",readTime:"30 min",author:{name:"RK Patel",role:"Microbiologist",avatar:"https://github.com/RKPatel-1996.png",affiliation:"Gujarat University"},excerpt:`
...
<h3>2.1. Subdivisions of Homology</h3>
  ...
  <ul>
    ...
    <li><strong>Example:</strong> <em>Human Hemoglobin α [<a href="https://www.rcsb.org/structure/2DN1" target="_blank">2DN1</a>]</em> vs. <em>Mouse Hemoglobin α [<a href="https://www.rcsb.org/structure/3HRW" target="_blank">3HRW</a>]</em>. Both transport oxygen, just in different animals.</li>
      ...
      <figure class="science-figure" data-id="Figure 8.1: " data-clean-src="${e}">
      <img src="${e}" alt="Orthologous Hemoglobin Alpha Chains" />
  ...
  <ul>
    ...
    <li><strong>Example:</strong> <em>Human Hemoglobin α</em> vs. <em>Human Hemoglobin β</em>. They arose from a duplication of an ancestral globin gene but now work together to form a complex structure.</li>
        ...
        <figure class="science-figure" data-id="Figure 8.2: " data-clean-src="${t}">
      <img src="${t}" alt="Paralogous Hemoglobin Alpha and Beta Chains" />
