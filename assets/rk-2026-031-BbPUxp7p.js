const i="/RKS-lab-notes/assets/f031_001-CiPnVx8p.png",t="/RKS-lab-notes/assets/f031_002-CMuI5dcQ.png",a="/RKS-lab-notes/assets/f031_003-LBzt8jjG.png",n="/RKS-lab-notes/assets/f031_004-P3hoZM8K.png",o="/RKS-lab-notes/assets/f031_005-j2v8WXGU.png",s="/RKS-lab-notes/assets/f031_006-B7jbWpwQ.png",l="/RKS-lab-notes/assets/f031_007-C74qBIvT.png",r="/RKS-lab-notes/assets/f031_008-C-fYdXff.png",c="/RKS-lab-notes/assets/f031_009-DrO1EvIt.png",h="/RKS-lab-notes/assets/f031_010-DbYkbjfy.png",g="/RKS-lab-notes/assets/F031_011-DGJ75WdL.png",d="/RKS-lab-notes/assets/f031_012-hKOj7Won.png",u="/RKS-lab-notes/assets/f031_013-BEIqGo9Y.png",f="/RKS-lab-notes/assets/f031_014-BP5XO8Oy.png",p="/RKS-lab-notes/assets/f031_015-8wOY7Nuq.png",m="/RKS-lab-notes/assets/f031_016-CHwQZhL_.png",e="/RKS-lab-notes/assets/f031_017-B7ASbZGI.png",b={id:"RK-2026-031",title:"Practical 4: MEGA- Phylogenetic tree plotting",date:"2026-03-15",tags:["#Tree","#Phylogenetic Tree","#MEGA"],type:"report",template:"standard",readTime:"30 min",author:{name:"RK Patel",role:"Microbiologist",avatar:"https://github.com/RKPatel-1996.png",affiliation:"Gujarat University"},excerpt:`
...
<figcaption>The MEGA Web Browser interface accessing the NCBI Nucleotide database. The image highlights the search bar with the query "Pseudomonas aeruginosa 16s rRNA", the "Search" button, and the "Add To Alignment" feature at the top of the window.</figcaption>
      ...
      <figure class="science-figure" data-id="Figure 3" data-clean-src="${a}">
<img src="${a}" alt="Screenshot of NCBI Nucleotide search results in the MEGA Web Browser, with the 'FASTA' link highlighted beneath the top result." />
...
<img src="${n}" alt="Screenshot of a sequence in FASTA format within the MEGA Web Browser, highlighting the 'GenBank' link to switch views." />
