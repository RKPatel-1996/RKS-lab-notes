const e="/RKS-lab-notes/assets/016_001-knMQw_Wj.png",t="/RKS-lab-notes/assets/016_002-CYNc09KT.png",o="/RKS-lab-notes/assets/016_003-BMH6h_YY.png",n="/RKS-lab-notes/assets/016_004-D15-T4g6.png",s="/RKS-lab-notes/assets/016_005-DsBONEUJ.png",i="/RKS-lab-notes/assets/016_006-DwDsfmha.png",a="/RKS-lab-notes/assets/016_007-DUCKNhaZ.png",r={id:"RK-2026-016",title:"Phylogenetic Tree construction using MEGA",date:"2026-02-05",tags:["#PhylogeneticTree","#MEGA","#bioinformatics"],type:"report",template:"standard",readTime:"30 min",author:{name:"RK Patel",role:"Microbiologist",avatar:"https://github.com/RKPatel-1996.png",affiliation:"Gujarat University"},excerpt:`
...
<figure class="science-figure" data-id="Figure: 1" data-clean-src="${e}"> 
    <img src="${e}" alt="Screenshot of the MEGA align option" />
</figure>

<figure class="science-figure" data-id="Figure: 1" data-clean-src="${t}"> 
    <img src="${t}" alt="Screenshot of the MEGA internal web browser showing the Add to Alignment button" />             
</figure>

<figure class="science-figure" data-id="Figure: 1" data-clean-src="${o}">
    <img src="${o}" alt="Screenshot of the MEGA alignment window showing the added sequences" />
...
<figure class="science-figure" data-id="Figure: 2" data-clean-src="${n}">
    <img src="${n}" alt="Screenshot of the MEGA alignment options showing the different algorithms and modes" />
...
<figure class="science-figure" data-id="Figure: 3" data-clean-src="${s}">
    <img src="${s}" alt="Screenshot of the MEGA alignment options showing the different parameters" />
...
<figure class="science-figure" data-id="Figure: 4" data-clean-src="${i}">
    <img src="${i}" alt="Screenshot of the MEGA tree construction options showing the different methods" />
...
<figure class="science-figure" data-id="Figure: 5" data-clean-src="${a}">
    <img src="${a}" alt="Screenshot of the MEGA maximum likelihood tree options showing the different parameters" />
